        ...
        return (
            ...
            <>
                ...
                <Stack tokens = { stackTokens } styles={stackStyles}>
                    <Checkbox label='Protected communities are only visible to members that have been invited by the communitys owner.' onChange={ this.onChange } defaultChecked={this.props.checkedValues[0]} />

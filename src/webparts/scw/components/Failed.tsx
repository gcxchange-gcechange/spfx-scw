      ...
      <div>
        {this.props.prefLang === "fr-fr" ? (
          <p>
            ...
            <a style={{ color: "#004DB8" }} href={`mailto: ${mailtoFR}`}>
              Envoyez‑nous un courriel
            </a>
            , et toutes les données entrées jusqu’à maintenant apparaîtront dans
            votre courriel.
          </p>
        ) : (
          <p>
            {this.strings.failed_txt1} Please{" "}
            <a href={`mailto: ${mailto}`}>send us an email</a>, and all the
            information you've entered so far will be pre-populated in the
            email.
          </p>
        )}
        ...
        {this.props.prefLang === "fr-fr" ? (
          <p>
            ...
            <a
              style={{ color: "#004DB8" }}
              href={`https://gcxgce.sharepoint.com/sites/Support/SitePages/fr/Home.aspx`}
            >
              {" "}
              le portail de soutien GCÉchange
            </a>{" "}
            <Icon
              style={{ color: "#004DB8" }}
          ...
          <p>
            ...
            <a
              style={{ color: "#004DB8" }}
              href={`https://gcxgce.sharepoint.com/sites/Support`}
            >
              GCXchange Support portal
            </a>{" "}
            <Icon
              style={{ color: "#004DB8" }}
              iconName="NavigateExternalInline"

...
export default class FirstStep extends React.Component<IFirstStepProps> {
    ...
    public render(): React.ReactElement<IFirstStepProps> {
        ...
        return (
            ...
            <Label htmlFor='Community purpose' required required styles={labelStyle}>Community purpose</Label>
            ...
            <Label htmlFor='engName' required  required  styles={labelStyle} >English community name</Label>
            ...
            <Label htmlFor='shEngDesc' required required  styles={labelStyle} >English description name</Label>
            <p className={ styles.instruction }>Max. 33 characters.</p>
            ...
            <Label htmlFor='shFrDesc' required required  styles={labelStyle} >French description name</Label>
            <p className={ styles.instruction }>Max. 33 characters.</p>

...
export default class FirstStep extends React.Component<IFirstStepProps> {
    ...
    public render(): React.ReactElement<IFirstStepProps> {
        ...
        return (
            ...
            <TextField type='text' name='commPurpose' id='Community purpose'  onChange={ this.commPurposeOnChange }defaultValue={ commPurpose } />
            ...
            <TextField  id={labels[0]} name='EngName' onChange={this.handleOnChangeEngNameEvent} defaultValue={engName} onGetErrorMessage={this.onGetErrorMessage} validateOnLoad={false}/>

...
define([], function() {
  return {
    ...
    "protected_next_btn": "I agree to the terms of use",
    ...
    "chk1":"Posting, uploading, and storing personal information is not permitted in GCXchange. Personal information includes any information of nonnational interest, the compromise of which would reasonably be expected to cause injury to a person or non-national interest (e.g., home addresses, phone numbers, social insurance numbers, and performance evaluations)",
    "chk1b":"I understand that as a community owner, I am responsible for ensuring all members know that personal information cannot be posted to GCXchange and that I am responsible for removing an personal information from GCXchange as soon as I am made aware.",
    "chk2":"Owners and Members must have a valid Government of Canada security clearance (Reliability or higher) to access Protected B communities.",
    "chk2b":"I understand that my community Members and I must have a valid Government of Canada security clearance of Reliability or higher.",
    "chk3":"All Owners and Members must use a Government Managed Device (GMD) to access Protected B communities (i.e., desktop computer, laptop, tablet).",
    "chk3b":"I understand that my community Members must use GFE to access my community.",
    "chk4":"When accessing a Protected B community, Owners and Members may be required to perform twofactor authentication.",
    "chk4b":"I understand that it is the responsibility of community Owners to ensure all Owners and Members of can perform twofactor authentication.",
    "chk5":"GCXchange users cannot request to join Protected B communities, they must be invited by a community Owner.",
    "chk5b":"I understand that Owners must invite Owners and Members to Protected B communities.",
    "chk6":"The GCXchange Support Team does not have access to Protected B communities. If they are required to provide help, an Owner is responsible for adding them to the community.",
    "chk6b":"I agree to grant access to GCXchange Support when needed.",
    "chk7":"Owners are responsible for managing community access. Only users with a valid business need to access the protected information should be included in protected B communities.",
    "chk7b":"I will review my community membership on a regular basis and remove anyone who no longer has a business need to access the information",
    "chk7c": "",
    "chk8": "GCXchange monitors all Protected B communities to ensure each one has at least two (2) owners at all times.",
    "chk8b": "I will ensure that our Protected B community has at least two (2) owners at all times.",
    "chk9":"All GCXchange communities (Unclassified and Protected B) are Private.  GCXchange monitors all communities to ensure that their status remains so.  Any community found to be set to Public is automatically reset to Private. ",
    "chk9b":"I will ensure that my community is always set to Private",
    "chk10":"GCXchange (unclassified and Protected B) is a transitory environment with a retention policy of two (2) years.  Any document that has not been modified for two (2) years will be automatically deleted. The owner is responsible for ensuring that any documents that must be retained are transferred to their department’s official repository. as required. ",
    "chk10b":"I agree to transfer my community documents to my department's official repository if they must be retained.",

...
define([], function() {
  return {
    ...
    "chk1":"Protected B communities are accessible and visible to Owners and Members only.",
    "chk1b":"I understand that my community will only be visible to Owners and Members.",
    "chk2":"GCXchange users cannot request to join protected B communities, they must be invited by the community owner.",
    "chk2b":"I understand that owners must invite members to protected B communities.",
    "chk3":"All members of protected B communities must have a multi-factor authentication prior to accessing any protected B community.",
    "chk3b":"I understand that members of my community must have a multi-factor authentication.",
    "chk4":"All members must use Government Furnished Equipment (GFE) to access protected B communities.",
    "chk4b":"I understand that my community members must use GFE to access my community.",
    "chk5":"Owners and members must have a valid Government of Canada security clearance (Reliability or higher) to access protected B communities.",
    "chk5b":"I understand that y community members must meet these requirements to access my community",
    "chk6":"GCXchange Support Team does not have access to Protected B communities. If they are required to provide help, the owner is responsible for adding them to the community.",
    "chk6b":"I agree to grant access to GCXchange Support when needed.",
    "chk7":"Owners are responsible for managing community access. Only users with a need-to-know protected information should be included in protected B communities.",
    ...
    "chk7c": "",
    "chk8": "GCXchange (unclassified and protected B) is a transitory environment with a retention policy of two (2) years for all documents. The owner is responsible for ensuring their documents are transferred to their department's official repository, as required.",

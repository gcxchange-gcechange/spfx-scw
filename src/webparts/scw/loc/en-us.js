...
define([], function() {
  return {
    ...
    "unclassified_cardText": "No, I don’t need to store protected information. All users will be able to find your community, and search for it.",
    "protected_cardTitle":"Protected A or B community",
    "protected_cardText":"Yes, I need to store protected information such as: consent forms, personal information, contact details for individuals or organizations, financial documentation, or other documents that, if compromised, could cause injury to an individual, organization or the government.",

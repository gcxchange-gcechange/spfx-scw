...
define([], function() {
  return {
    ...
    "invite_owners_members": "Invite owners.",
    ...
    "collaborate":"Collaborate with colleagues across departments using Microsoft Teams and Sharepoint to share ideas, documents, and much more. Make sure to only store <strong>unclassified documents</strong>",
    ...
    "protected_or_unclassified_smallText": "Colleagues not yet registered for GCXchange can <a className={styles.blue} >register to GCXchange</a>",
    "Lets_go": "Let's go",
    ...
    "review_info":"Review that the information below and make any required changes before submitting.",
    "prev_btn":"Previous",
    "next_btn": "Next",

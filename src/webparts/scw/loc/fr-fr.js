...
define([], function() {
    return {
        ...
        "protected_next_btn": "J'accepte les conditions d'utilisation",
       ...
       "chk1": "L’affichage, le téléchargement et la conservation de renseignements personnels ne sont pas autorisés dans GCÉchange. Les renseignements personnels comprennent tout renseignement d’intérêt non national dont la compromission pourrait raisonnablement causer un préjudice à une personne ou à un intérêt non national (par exemple, les adresses personnelles, les numéros de téléphone, les numéros d’assurance sociale et les évaluations de rendement)",
       "chk1b": "Je comprends qu’en tant que propriétaire d’une communauté, je suis responsable de veiller à ce que tous les membres sachent qu’il est interdit de publier des renseignements personnels sur GCÉchange et je suis responsable de supprimer tout renseignement personnel de GCÉchange dès que j’en suis informé.",
       "chk2": "Les propriétaires et les membres doivent être titulaires d’une cote de sécurité valide du gouvernement du Canada (Fiabilité ou niveau supérieur) pour accéder aux communautés Protégé B.",
       "chk2b": "Je comprends que les membres de ma communauté et moi-même devons être titulaires d’une cote de sécurité valide du gouvernement du Canada de niveau « Fiabilité » ou supérieure.",
       "chk3": "Tous les propriétaires et membres doivent utiliser un dispositif géré par le gouvernement pour accéder aux communautés Protégé B (c’est-à-dire un ordinateur de bureau, un ordinateur portable, ou une tablette).",
       "chk3b": "Je comprends que les membres de ma communauté doivent utiliser l’équipement fourni par le gouvernement pour accéder à ma communauté.",
       "chk4": "Lors de l’accès à une communauté Protégé B, les propriétaires et les membres peuvent être tenus d’effectuer une authentification à deux facteurs.",
       "chk4b": "Je comprends que les propriétaires de la communauté sont responsables de s’assurer que tous les propriétaires et membres de la communauté Protégé B peuvent faire une authentification à deux facteurs.",
       "chk5": "Les utilisateurs de GCÉchange ne peuvent pas demander à rejoindre les communautés Protégé B; ils doivent être invités par le propriétaire d’une communauté.",
       "chk5b": "Je comprends que les propriétaires doivent inviter les propriétaires et les membres dans les communautés Protégé B.",
       "chk6": "L’équipe de soutien de GCÉchange n’a pas accès aux communautés Protégé B. Si de l’aide est requise, un propriétaire est chargé de les ajouter à la communauté.",
       "chk6b": "J’accepte de donner accès à l’équipe de soutien de GCÉchange au besoin.",
       "chk7": "Les propriétaires sont responsables de la gestion de l’accès à la communauté. Seuls les utilisateurs ayant un besoin professionnel valable d’accéder aux renseignements protégés doivent être ajoutés aux communautés Protégé B.",
       "chk7b": "Je vérifierai régulièrement les membres de ma communauté et je supprimerai toute personne qui n’a plus besoin d’accéder à l’information pour des raisons professionnelles.",
       "chk8": "GCÉchange surveille toutes les communautés Protégé B pour s’assurer que chacune d’entre elles compte au moins deux (2) propriétaires à tout moment.",
       "chk8b": "Je veillerai à ce que notre communauté Protégé B compte au moins deux (2) propriétaires à tout moment.",
       "chk9":"Toutes les communautés de GCÉchange (Non classifié et Protégé B) sont privées. GCÉchange surveille toutes les communautés afin de s’assurer que leur statut demeure privé. Toute communauté configurée comme Publique est automatiquement rétablie en mode Privé.",
        "chk9b":"Je veillerai à ce que ma communauté soit toujours réglée en mode Privé.",
        "chk10":"GCéchange (Non classifié et Protégé B) est un environnement transitoire dont la politique de conservation des données est de deux (2) ans. Tout document qui n’a pas été modifié depuis deux (2) ans sera automatiquement supprimé. Le propriétaire est responsable de s’assurer que tout document devant être conservés soit transféré dans le dépôt officiel de son ministère, au besoin.",
        "chk10b":"J’accepte de transférer les documents de ma communauté dans le dépôt officiel de mon ministère s’ils doivent être conservés.",

...
define([], function() {
    return {
        ...
        "CommPurpose": 'L’équipe de soutien de GCÉchange doit connaître l’objectif de la nouvelle collectivité pour déterminer si elle peut être <strong>approuvée</strong>.<br/> Cette information n’apparaîtra pas sur votre site. Rédiger l’information dans la langue officielle de votre choix. Il doit comporter de 5 à 500 caractères.',

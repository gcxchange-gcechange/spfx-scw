...
define([], function() {
    return {
        ...
        "collaborate": "Collaborer avec des collègues d’autres ministères en utilisant Microsoft Teams et Sharepoint pour échanger, entre les ministères et organismes, des idées, des documents, et bien plus encore.",
       ...
       "chk1": "Les collectivités Protégé B sont visibles pour les propriétaires et aux membres seulement",
       "chk1b": "Je comprends que ma collectivité sera visible pour les propriétaires et les membres seulement.",
       "chk2": "Les utilisateurs de GCÉchange ne peuvent pas demander de se joindre à une collectivité Protégé B, car ils doivent y avoir été invités par le propriétaire de la collectivité",
       "chk2b": "Je comprends que les propriétaires doivent inviter les membres aux collectivités Protégé B.",
       "chk3": "Tous les membres des collectivités Protégé B doivent être soumis à un processus d’authentification multifacteur avant d’accéder à une collectivité Protégé B. ",
       "chk3b": "Je comprends que les membres de ma collectivité doivent être soumis à un processus d’authentification multifacteur.",
       "chk4": "Tous les membres doivent utiliser l’équipement fourni par le gouvernement (EFG) pour accéder aux collectivités Protégé B",
       "chk4b": "Je comprends que les membres de ma collectivité doivent utiliser l’EFG pour accéder à ma collectivité.",
       "chk5": "Les propriétaires et les membres doivent détenir une autorisation de sécurité valide du gouvernement du Canada (cote de fiabilité ou cote supérieure) pour accéder aux collectivités Protégé B.",
       "chk5b": "Je comprends que les membres de ma collectivité doivent répondre à ces exigences pour accéder à ma collectivité.",
       "chk6": "L’équipe de soutien de GCÉchange n’a pas accès aux collectivités Protégé B. Si un membre de cette équipe doit fournir son aide, le propriétaire doit l’ajouter à la collectivité.",
       "chk6b": "Je consens à accorder l’accès à l’équipe de soutien de GCÉchange lorsque la situation l’exige.",
       "chk7": "Les propriétaires sont responsables de la gestion de l’accès aux collectivités. Seuls les utilisateurs dont les renseignements protégés sont accompagnés de l’exigence du besoin de connaître doivent être intégrés aux collectivités Protégé B",
       ...
       "chk8": "GCÉchange (non classifié et Protégé B) est un environnement de transition comportant une politique de conservation valide deux (2) ans pour tous les documents. Le propriétaire doit s’assurer que ses documents sont transférés au registre officiel de son ministère, le cas échéant.",

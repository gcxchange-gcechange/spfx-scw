...
define([], function() {
    return {
        ...
        "collaborate": "Collaborer avec des collègues d’autres ministères en utilisant Microsoft Teams et Sharepoint pour échanger des idées, des documents, et bien plus encore. Make sure to only store <strong>unclassified documents</strong>",
        ...
        "indentify_one_more_owner": "Indiquer au moins <strong className={ styles.blue }>un autre responsable</strong> already registered to GCXchange",
        ...
        "invite_owners_para2": "Vous devez <strong>ajouter au moins un responsable supplémentaire</strong> avant de créer votre collectivité.",
        ...
        "invite_owners_label": "Inviter les responsables already registered to GCXchange",
        ...
        'failed_txt4': 'If you do not reveid the email or you do have any questions, please submit a service request using the',

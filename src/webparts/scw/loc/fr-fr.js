...
define([], function() {
    return {
        ...
        "owners_Instruction": 'Commencez à taper l’adresse courriel d’un member pour le trouver et l’ajouter.',
        "owners_instruction_Callout": "Commencez à taper l’adresse courriel d’un member (qui est inscrit GCÉchange) pour les trouver et les ajouter.",

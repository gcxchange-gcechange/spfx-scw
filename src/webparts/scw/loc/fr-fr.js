...
define([], function() {
    return {
        ...
        "unclassified": "Veillez à <strong>ne pas stocker</strong> de documents classifiés dans votre bibliothèque. Si vous ne savez pas quels renseignements sont classifiés, vous pouvez consulter la politique de sécurité de votre ministère ou la direction de la gestion de l’information.",
        "unclassified_para2":"",

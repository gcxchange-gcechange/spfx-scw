...
define([], function() {
    return {
      ...
      "complete_button": "Page d’accueil de GCÉchange",
        ...
        'failed_txt1': 'Let us try to make uit right. Please <a>send us an email</a>, and all the information you\'ve entered so far will be pre-populated in the email.',
